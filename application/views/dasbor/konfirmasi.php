					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<small>Misal: Harun AR-Rasyid</small>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<div class="btn-group">
									<button class="btn btn-primary btn-lg" type="submit" name="submit"><i class="fa fa-upload"></i> Submit</button>
									<button class="btn btn-danger btn-lg" type="reset" name="reset"><i class="fa fa-time"></i> Reset</button>
								</div>
							</td>
						</tr>
					</tbody>
